...
#[derive(Clone)]
pub struct SIArray1(pub(crate) SIArray1);

#[pyclass(name = "SIArray2", module = "si_units")]
#[derive(Clone)]
pub struct SIArray2(pub(crate) SIArray2);

#[pyclass(name = "SIArray3", module = "si_units")]
#[derive(Clone)]
pub struct SIArray3(pub(crate) SIArray3);

#[pyclass(name = "SIArray4", module = "si_units")]
#[derive(Clone)]
pub struct SIArray4(pub(crate) SIArray4);

// Adding the macro is not sufficient.
// You need to add _mul_ and _div_ in sinumber.rs to construct from numpy arrays.
impl_array!(SIArray1, SIArray1, PyReadonlyArray1<f64>);
impl_array!(SIArray2, SIArray2, PyReadonlyArray2<f64>);
impl_array!(SIArray3, SIArray3, PyReadonlyArray3<f64>);
impl_array!(SIArray4, SIArray4, PyReadonlyArray4<f64>);
